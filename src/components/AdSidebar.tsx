export default function AdSidebar() {
  return (
    <div className="w-full h-[250px] bg-gradient-to-r from-white/5 to-white/3 border border-white/10 rounded-xl flex items-center justify-center text-gray-500 text-sm">
